        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-[#3A3F45] text-lg md:text-xl leading-relaxed mb-8">
              Ган Групп нь барилгын зураг төсөл, үйлдвэрлэл, гүйцэтгэл, төсөв тооцоо,
              зөвлөх үйлчилгээ, бэлтгэн нийлүүлэлтийг нэг удирдлага дор уялдуулан
              хэрэгжүүлдэг цогц систем юм.
            </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[#A7A9AC] text-lg font-medium">
              Мөрөөдлийг тань хамтдаа бүтээе
            </p>
          </div>
